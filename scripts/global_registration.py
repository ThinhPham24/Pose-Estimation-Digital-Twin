# ----------------------------------------------------------------------------
# 20250307-QHD: Based on Open3D example and documentation
# https://github.com/isl-org/Open3D/blob/main/examples/python/benchmark/benchmark_fgr.py
...
def draw_registration_result(source, target, transformation):
    ...
    # TODO: Study why do we need this
