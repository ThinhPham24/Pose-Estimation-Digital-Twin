...
def parse_arguments(args):
    ...
    parser.add_argument('--target-width', default=100, type=int, help='The target width')
    parser.add_argument('--target-height', default=55, type=int, help='The target height')
